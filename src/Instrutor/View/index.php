...
?>
<link rel="stylesheet" href="/src/Instrutor/View/assets/instrutor.css">
        <!-- Main content -->
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-primary card-outline">
                            <form class="form" id="formInstrutores" name="formInstrutores" onsubmit="return false;">
                                <div class="card-header">
                                    <h5 class="m-0"><i class="fas fa-chalkboard-teacher"></i> Gerenciar Instrutores</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row justify-content-between mt-3 mr-2">
                                        ...
                                        <button type="submit" class="btn btn-outline-success" onclick="_instrutor.cadastrar()"><i class="far fa-check-square mr-1"></i> Cadastrar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="m-0"><i class="fas fa-users"></i> Lista de Instrutores</h5>
                            </div>
                            <div class="card-body">
    ...
    <div class="modal fade" id="modalAluno" tabindex="-1" role="dialog" aria-labelledby="modalAlunoLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <form class="form" id="formInstrutorModal" onsubmit="return false;">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalAlunoLabel">Alterar Informações do Instrutor</h5>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    ...
                                    <input type="hidden" id="ModalIdInstrutor" name="ModalIdInstrutor" required>
                                </div>
                                <div class="col-lg-2 col-sm-12">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-lg-2 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="ModalBairro" name="ModalBairro">
                                </div>
                                <div class="col-lg-2 col-sm-12">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-lg-2 col-sm-12">
                                    ...
                                    <span class="d-none text-danger obrigatorioModal">* Campo obrigatorio</span>
                                </div>
                                <div class="col-lg-3 col-sm-12">
...
?>
<script src="/src/Instrutor/View/assets/instrutor.js"></script>
