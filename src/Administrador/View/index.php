                            ...
                            <div class="card-body">
                              <form class="form" id="formCadastro" onsubmit="return false;">
                                ...
                                <div class="row justify-content-between mt-3 mr-2">
                                    <span>Todos os campos com <span class="text-danger">*</span> são obrigatórios.</span>
            ...
            <div class="modal-content">
                <form class="form" id="formAlterar" onsubmit="return false;">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalAlunoLabel">Alterar Informações do Administrador</h5>
